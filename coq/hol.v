...
Lemma SYM a t u : proof (EQ a t u) -> proof (EQ a u t).
Proof.
  intro H.
  apply (EQ_MP (EQ a t t)).
  - apply APP_THM.
    + apply APP_THM.
      * apply REFL.
      * assumption.
...
Lemma TRANS a t u v : proof (EQ a t u) -> proof (EQ a u v) -> proof (EQ a t v).
Proof.
  intros H1 H2.
  apply (EQ_MP (EQ a u v)).
  - apply APP_THM.
    + apply APP_THM.
      * apply REFL.
      * apply SYM.
...
Definition PROVE_HYP (x : term bool) (y : term bool) (H1 : proof x) (H2 : proof x -> proof y) : proof y := H2 H1.
